...
class PokemonServiceTest {
    ...
    @Test
    fun `should return all pokemons from list`() {
        ...
        expectedPokemons.forEachIndexed { index, expectedPokemon ->
            val pokemon = result[index]

            assertThat(pokemon.pokedexNumber).isEqualTo(expectedPokemon.pokedexNumber)
            assertThat(pokemon.name).isEqualTo(expectedPokemon.name)
            assertThat(pokemon.types).containsExactlyElementsOf(expectedPokemon.types)
            assertThat(pokemon.imageUrl).isEqualTo(expectedPokemon.imageUrl)
        }
    }

    @Test
    fun `should return pokemon by pokedexNumber from list`() {
        val expectedPokemons = listOf(
            Pokemon(
                1,
                "Bulbasaur",
        ...
        expectedPokemons.forEach { expectedPokemon ->
            val result = pokemonService.getPokemonById(expectedPokemon.pokedexNumber)

            assertThat(result?.name).isEqualTo(expectedPokemon.name)
            assertThat(result?.types).containsExactlyElementsOf(expectedPokemon.types)
            assertThat(result?.pokedexNumber).isEqualTo(expectedPokemon.pokedexNumber)
            assertThat(result?.imageUrl).isEqualTo(expectedPokemon.imageUrl)
        }
    }
