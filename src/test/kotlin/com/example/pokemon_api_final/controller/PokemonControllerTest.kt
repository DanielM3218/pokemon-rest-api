...
class PokemonControllerTest {
    ...
    private val expectedPokemons = listOf(
        ...
        Pokemon(
            ...
            URL("https://img.pokemondb.net/artwork/large/caterpie.jpg")
        ),
        ...
        Pokemon(
            ...
            "Raichu",
            listOf(PokemonType.ELECTRIC),
            URL("https://img.pokemondb.net/artwork/large/raichu.jpg")
        ),
        Pokemon(
            27,
            "Sandshrew",
        ...
        Pokemon(
            ...
            URL("https://img.pokemondb.net/artwork/large/clefairy.jpg")
        ),
        Pokemon(
            36,
            "Clefable",
            listOf(PokemonType.FAIRY),
            URL("https://img.pokemondb.net/artwork/large/clefable.jpg")
        ),
        ...
        Pokemon(
            ...
            "Dugtrio",
            listOf(PokemonType.GROUND),
            URL("https://img.pokemondb.net/artwork/large/dugtrio.jpg")
        ),
        Pokemon(
            48,
            "Meowth",
            listOf(PokemonType.NORMAL),
            URL("https://img.pokemondb.net/artwork/large/meowth.jpg")
        ),
        Pokemon(
            49,
            "Persian",
            listOf(PokemonType.NORMAL),
            URL("https://img.pokemondb.net/artwork/large/persian.jpg")
        ),
        Pokemon(
            50,
            "Psyduck",
            listOf(PokemonType.WATER),
            URL("https://img.pokemondb.net/artwork/large/psyduck.jpg")
        ),
        Pokemon(
            51,
            "Golduck",
            listOf(PokemonType.WATER),
            URL("https://img.pokemondb.net/artwork/large/golduck.jpg")
        ),
        Pokemon(
            52,
            "Mankey",
        ...
        Pokemon(
            ...
            "Poliwag",
            listOf(PokemonType.WATER),
            URL("https://img.pokemondb.net/artwork/large/poliwag.jpg")
        ),
        Pokemon(
            57,
            "Poliwhirl",
        ...
        Pokemon(
            ...
            "Politoed",
            listOf(PokemonType.WATER),
            URL("https://img.pokemondb.net/artwork/large/politoed.jpg")
        ),
        ...
        Pokemon(
            ...
            URL("https://img.pokemondb.net/artwork/large/kadabra.jpg")
        ),
        Pokemon(
            61,
            "Alakazam",
        ...
        Pokemon(
            ...
            "Mewtwo",
            listOf(PokemonType.PSYCHIC),
            URL("https://img.pokemondb.net/artwork/large/mewtwo.jpg")
        ),
        ...
        Pokemon(
            ...
            "Grimer",
            listOf(PokemonType.POISON),
            URL("https://img.pokemondb.net/artwork/large/grimer.jpg")
        ),
    ...
    fun `should return a list of pokemons on successful request`() {
        ...
        val response = ResponseEntity.ok(pokemonController.listAllPokemons())

        assertThat(response.statusCode).isEqualTo(HttpStatus.OK)
        assertThat(response.body).isNotNull
        assertThat(response.body).hasSize(expectedPokemons.size)
        assertThat(response.body).isEqualTo(expectedPokemons)
    }

    @Test
    fun `getPokemonById should return pokemon when it exists`() {
        val validPokedexNumber = 1
        val expectedPokemon = expectedPokemons.first()

        `when`(pokemonService.getPokemonById(validPokedexNumber)).thenReturn(expectedPokemon)

        val response: ResponseEntity<Pokemon> = pokemonController.getPokemonById(validPokedexNumber)
    ...
    fun `getPokemonById should return not found when pokemon does not exist`() {
        ...
        val response: ResponseEntity<Pokemon> = pokemonController.getPokemonById(nonExistentPokedexNumber)
